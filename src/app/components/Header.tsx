...
export default function Header({ showTitle, title }: HeaderProps) {
  ...
  return (
    <>
      ...
      {/* Sidebar Menu */}
      <div className={`fixed top-0 right-0 h-full w-[70%] bg-black transform rounded-bl-4xl transition-transform duration-300 ease-in-out z-[9999] ${isMenuOpen ? 'translate-x-0' : 'translate-x-full'
        }`}>
