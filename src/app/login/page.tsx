  ...
  return (
    <div className="fixed inset-0 bg-gray-50 flex flex-col">
        ...
        <div className="bg-white rounded-t-4xl p-8 pb-24 border-4 border-b-0 border-black -mx-6 -mb-8 min-h-[calc(100vh-220px)]">
          ...
          <div className="text-center mb-8">
            <button
              ...
              className="text-primary-green font-medium hover:underline font-euclid-bold"
            >
              Ai uitat parola?
            </button>
          </div>
          ...
          <div className="text-center mb-6">
            ...
            <div className="flex justify-center space-x-4">
              ...
              <button
                ...
                className="w-16 h-16 rounded-3xl flex items-center justify-center hover:bg-yellow-500 transition-colors shadow-lg"
              >
              ...
              <button
                ...
                className="w-16 h-16 bg-black rounded-3xl flex items-center justify-center hover:bg-gray-800 transition-colors shadow-lg"
              >
                <svg viewBox="0 0 24 24" className="w-8 h-8">
      ...
      <div className="absolute bottom-0 left-0 right-0 px-6 py-6 z-30">
        ...
        <button
          onClick={handleLogin}
          className="w-full bg-black text-white py-4 rounded-3xl border-4 border-black font-bold text-lg hover:bg-gray-800 transition-colors"
        >
          Login
        </button>
      </div>
