      ...
      <div className="flex-1 px-6 py-4 -mt-20 z-15">
        <div className="bg-white rounded-t-4xl p-8 pb-24 border-4 border-b-0 border-black -mx-6 -mb-8 min-h-[calc(100vh-200px)]">
          ...
          <div className="text-center mb-6">
            <p className="text-black font-medium mb-4">sau înregistrează-te cu</p>
            <div className="flex justify-center space-x-4">
              {/* Google */}
              <button
                onClick={() => handleSocialLogin('google')}
                className="w-16 h-16 bg-yellow-400 rounded-3xl flex items-center justify-center hover:bg-yellow-500 transition-colors shadow-lg"
              >
