...
export default function OnboardingScreen2() {
  ...
  const handleNext = () => {
    // Navigate to onboarding_screen_3 or main app
    router.push('/onboarding_screen_3');
  };
  return (
    <div className="fixed inset-0 bg-gray-50 flex flex-col">
      ...
      <div className="flex-1 relative px-6 pt-16">
        ...
        <div className="absolute inset-x-6 top-16 -bottom-6 flex flex-col">
          <div className="bg-white rounded-4xl pt-8 px-8 border-4 border-black flex-1 flex flex-col z-10">
            {/* Title */}
            <div className="text-center mb-8">
              <h1 className="text-3xl font-bold text-primary-green">Pasul 2</h1>
            </div>

            {/* Illustration */}
            <div className="flex-1 flex items-end justify-center mt-10">
              <Image
                src="/illustrations/onboarding_step2_illustration.png"
      ...
      {/* Bottom Card */}
      <div className="bg-primary-light-green rounded-t-4xl px-6 py-8 h-96 z-20">
        {/* White Inner Card */}
